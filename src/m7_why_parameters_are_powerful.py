...
def run_test_even_better_draw_circles():
    ...
    print('--------------------------------------------------')
    even_better_draw_circles(40, 5, 1.00)


def even_better_draw_circles(n, a, p):
    # n = amount by which the radii vary
    # a = number of concentric circles drawn
    # p = speed at which the animation runs
